...
export const ProductShowcase = () => {
  ...
  return <section className="px-4 bg-white py-[19px]">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-serif mb-12 text-center text-black text-6xl my-px font-normal">Featured Products</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {products.map(product => <div key={product.id} className="bg-gray-900 rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <Button className="w-full bg-yellow-500 hover:bg-yellow-600" onClick={() => navigate("/shop")}>
                  Buy
                </Button>
              </div>
            </div>)}
