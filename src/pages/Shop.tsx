  ...
  return <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-black via-transparent to-black">
          <img src="/lovable-uploads/7798e27a-edc7-4260-aa26-01a7b75992c6.png" alt="Gold Investment" className="w-full h-full object-cover opacity-50" />
        </div>
            ...
            <div className="flex gap-4">
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-gray-800 border border-gold/20">
                  <DropdownMenuItem className="text-gray-200 bg-white">Price: Low to High</DropdownMenuItem>
                  <DropdownMenuItem className="text-gray-200 bg-white">Price: High to Low</DropdownMenuItem>
                  <DropdownMenuItem className="text-gray-200 bg-white">Newest First</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map(product => <Card key={product.id} className="backdrop-blur-sm border-gold/20 hover:border-gold/40 transition-all duration-300 group bg-white">
              <CardHeader className="p-0">
                <div className="aspect-square relative overflow-hidden rounded-t-lg">
                  <img src={product.image} alt={product.name} className="object-cover w-full h-full transform group-hover:scale-105 transition-transform duration-500" loading="lazy" />
              ...
              <CardContent className="p-6 bg-white">
                ...
                <p className="mb-4 line-clamp-3 text-black">{product.description}</p>
